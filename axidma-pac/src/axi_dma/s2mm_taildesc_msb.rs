...
pub type R = crate::R<S2mmTaildescMsbSpec>;
#[doc = "Register `s2mm_taildesc_msb` writer"]
pub type W = crate::W<S2mmTaildescMsbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn taildesc_ptr(&mut self) -> TaildescPtrW<S2mmTaildescMsbSpec> {
        TaildescPtrW::new(self, 0)
    }
}
#[doc = "S2MM Tail Descriptor Pointer. Upper 32 address bits.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s2mm_taildesc_msb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s2mm_taildesc_msb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S2mmTaildescMsbSpec;
impl crate::RegisterSpec for S2mmTaildescMsbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s2mm_taildesc_msb::R`](R) reader structure"]
impl crate::Readable for S2mmTaildescMsbSpec {}
#[doc = "`write(|w| ..)` method takes [`s2mm_taildesc_msb::W`](W) writer structure"]
impl crate::Writable for S2mmTaildescMsbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets s2mm_taildesc_msb to value 0"]
impl crate::Resettable for S2mmTaildescMsbSpec {
